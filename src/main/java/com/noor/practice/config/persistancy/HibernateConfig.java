package com.noor.practice.config.persistancy;
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        ...
        if(this.sessionFactory == null) {
            ...
            try {
                ...
                configuration.addPackage("com.noor.practice.model");

                for(Class<?> modelClass: (new Reflections("com.noor.practice.model")).getTypesAnnotatedWith(Entity.class) ) {
